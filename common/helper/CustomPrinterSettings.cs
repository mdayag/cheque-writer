...
namespace common
{
    public class CustomPrinterSettings
    {
        ...
        */
        ...
        public static void Add_8_Point_5_By_2_Point_75_PaperSize()
        {
            AddCustomPaperSize("8.5x2.75", 215.9f, 69.8f);
        }

        public static void Add_8_Point_5_By_5_Point_5_PaperSize()
        {
            AddCustomPaperSize("8.5x5.5", 215.9f, 139.7f);
        }

        public static void Add_14_By_5_Point_5_PaperSize()
        {
            AddCustomPaperSize("14x5.5", 355.6f, 139.7f);
        }

        public static void AddLongPaperSize()
        {
            AddCustomPaperSize("Long", 330.2f, 215.9f);
        }
        ...
        public static void AddCustomPaperSize(string sPaperName, float widthMm, float heightMm)
        {
            PrintDocument pd = new PrintDocument();
            string sPrinterName = pd.PrinterSettings.PrinterName;
            AddCustomPaperSize(sPrinterName, sPaperName, widthMm, heightMm);
        }
